...
def PostListView(request):
    ...
    return render(request, 'newsdigest/postlist.html', context)
...
def UserInfoView(request, username):
    ...
    context = {'user': user, }
    return render(request, 'newsdigest/userinfo.html', context)
...
def UserSubmissions(request, username):
    ...
    for post in posts:
        post.count_votes()
        post.count_comments()
    return render(request, 'newsdigest/user_posts.html', {'posts': posts})
...
def EditListView(request, id):
    ...
    return render(request, 'newsdigest/submit.html', {'form': form})
...
def CommentReplyView(request, id1, id2):
    ...
    return render(request, 'newsdigest/reply_post.html', context)
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'newsdigest/auth_signup.html', {'form': form})
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, 'newsdigest/auth_signin.html', {'form': form})
